...
**Awaiting review** lists specs and plans with an open review (see [Reviews and comments](reviews-and-comments.md)), and specs in review that nobody has checked yet, such as fresh git imports. Use the archive
