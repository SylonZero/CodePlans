...
| MCP server — 68 tools incl. native specs with version history, reviews & comments, responsibilities, product/asset/dependency management, model refactoring (move_asset), releases, design notes & the asset record | ✅ Available |
